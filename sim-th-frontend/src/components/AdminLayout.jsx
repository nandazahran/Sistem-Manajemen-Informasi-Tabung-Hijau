...
function AdminLayout({ children }) {
  ...
  const adminMenuItems = [
    ...
    { name: 'Kelola Transaksi', path: '/admin/kelola-transaksi', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
    { name: 'Riwayat Transaksi', path: '/admin/riwayat-transaksi', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
    { name: 'Kelola User', path: '/admin/kelola-user', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
    { name: 'Kelola Wilayah', path: '/admin/kelola-wilayah', icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z' },
    { name: 'Kelola Kategori', path: '/admin/kelola-kategori', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
    { name: 'Leaderboard KPI', path: '/admin/leaderboard', icon: 'M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z' },
    { name: 'Laporan', path: '/admin/laporan', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
    { name: 'Profil', path: '/admin/profil', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
  ];

  const handleSearch = (e) => {
    if (e.key === 'Enter' && e.target.value) {
      navigate('/admin/kelola-transaksi');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-[#F5EFE6] flex font-sans animate-fade-in">
      ...
      {/* SIDEBAR ADMIN */}
      <aside className={`w-72 bg-[#0B4D1E] text-white flex flex-col fixed h-full z-40 transition-transform duration-500 ease-in-out overflow-y-auto ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <header className="h-24 bg-white flex items-center justify-between px-10 sticky top-0 z-30 shadow-sm border-b border-gray-100">
          <div className="flex items-center gap-6 flex-1">
            ...
            <div className="relative w-full max-w-2xl">
              ...
              <input 
                type="text" 
                placeholder="Cari wilayah, user, kategori, laporan..." 
          ...
          <div className="flex items-center gap-6">
            ...
            {/* INI BAGIAN TOMBOL NOTIFIKASINYA YANG UDAH DIBENERIN (BISA DI-KLIK) */}
            <button onClick={() => navigate('/admin/notifikasi')} className="relative p-2 rounded-full hover:bg-gray-100 transition-colors">
            ...
            {/* PROFIL ADMIN */}
            <Link to="/admin/profil" className="flex items-center gap-4 cursor-pointer hover:opacity-80 transition-opacity">
              <div className="text-right">
                <p className="font-extrabold text-[#0B4D1E] text-sm">Admin SIM-TH</p>
                <p className="text-xs text-[#F4A300] font-bold bg-[#F4A300]/10 inline-block px-3 py-1 rounded-full mt-1">BEM KM LH</p>
              </div>
