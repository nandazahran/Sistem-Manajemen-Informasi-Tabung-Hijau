...
function AuthLayout({ children, title, subtitle }) {
  ...
  return (
    ...
    <div data-aos="fade-in" className="min-h-screen bg-[#FAF8F5] relative flex flex-col items-center justify-center p-4 font-sans overflow-hidden">
      ...
      <div data-aos="zoom-in" data-aos-delay="100" className="bg-[#0A391D] p-4 rounded-2xl mb-8 z-10 shadow-lg">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
        </svg>
      </div>

      <div data-aos="fade-up" data-aos-delay="200" className="bg-white w-full max-w-md rounded-4xl p-8 sm:p-10 shadow-xl z-10">
