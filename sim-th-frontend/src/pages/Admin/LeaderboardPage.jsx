...
function LeaderboardPage() {
  ...
  const visibleData = isExpanded ? leaderboardData.slice(3) : leaderboardData.slice(3, 5); // Tunjukin 2 baris aja sebelum expand
    ...
    <AdminLayout>
      ...
      <div className="bg-[#0B4D1E] rounded-[2rem] p-10 flex flex-col md:flex-row items-start md:items-center justify-between shadow-sm mt-2 mb-8">
        ...
        <div className="relative">
          <select className="bg-[#F4A300] text-white px-6 py-3.5 rounded-xl font-bold outline-none cursor-pointer appearance-none pr-10 shadow-md">
            <option>Mei 2026</option><option>April 2026</option>
          </select>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 absolute right-4 top-1/2 transform -translate-y-1/2 text-white pointer-events-none" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" /></svg>
        </div>
      </div>
      ...
      <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 mb-8">
        ...
        <div className="flex flex-col md:flex-row justify-center items-end gap-4 h-56 px-4">
          {/* #2 Rank */}
          <div className="w-full md:w-1/3 bg-[#8FA57A] rounded-t-3xl h-[70%] flex flex-col items-center justify-center text-white relative shadow-lg">
            <div className="absolute -top-6 bg-white/20 p-2 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /></svg></div>
          ...
          {/* #1 Rank */}
          <div className="w-full md:w-1/3 bg-[#F4A300] rounded-t-3xl h-[100%] flex flex-col items-center justify-center text-white relative shadow-xl z-10">
            <div className="absolute -top-8 bg-white/30 p-3 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 2a1 1 0 011 1v1.323l3.954 1.582 1.599-.8a1 1 0 01.894 1.79l-1.233.616 1.738 5.42a1 1 0 01-.285 1.05A3.989 3.989 0 0115 15a3.989 3.989 0 01-2.667-1.019 1 1 0 01-.285-1.05l1.715-5.349L11 6.477V16h2a1 1 0 110 2H7a1 1 0 110-2h2V6.477L6.237 7.582l1.715 5.349a1 1 0 01-.285 1.05A3.989 3.989 0 015 15a3.989 3.989 0 01-2.667-1.019 1 1 0 01-.285-1.05l1.738-5.42-1.233-.617a1 1 0 01.894-1.788l1.599.799L9 4.323V3a1 1 0 011-1z" clipRule="evenodd" /></svg></div>
          ...
          {/* #3 Rank */}
          <div className="w-full md:w-1/3 bg-[#0B4D1E] rounded-t-3xl h-[60%] flex flex-col items-center justify-center text-white relative shadow-lg">
            <div className="absolute -top-6 bg-white/10 p-2 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /></svg></div>
      ...
      <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden mb-6 p-2">
        ...
        <table className="w-full text-left border-collapse">
          <thead className="bg-transparent text-[#0B4D1E]">
            <tr>
              <th className="px-8 py-5 font-bold">Rank</th><th className="px-8 py-5 font-bold">Wilayah</th><th className="px-8 py-5 font-bold">KPI</th>
              <th className="px-8 py-5 font-bold">Total Input (kg)</th><th className="px-8 py-5 font-bold">Nilai Ekonomi</th><th className="px-8 py-5 font-bold text-center">Trend</th>
            </tr>
          </thead>
        ...
        {!isExpanded && (
           <div className="text-center p-4 border-t border-gray-100">
             <button onClick={() => setIsExpanded(true)} className="text-[#0B4D1E] font-bold text-sm hover:underline">Tampilkan Lebih Banyak ⬇</button>
           </div>
        )}
      </div>

      {/* KPI BREAKDOWN (GREEN CARD) */}
