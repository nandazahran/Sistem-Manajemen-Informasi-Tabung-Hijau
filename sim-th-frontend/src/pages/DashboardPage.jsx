...
function DashboardPage() {
  return (
    <DashboardLayout>
      ...
      {/* BANNER: Gradient sesuai figma (F5EFE6 ke 8FA57A 20%) & rounded-3xl */}
      <div className="bg-linear-to-r from-[#F5EFE6] via-[#F5EFE6] to-[#8FA57A]/30 rounded-3xl p-12 flex items-center justify-between shadow-sm relative overflow-hidden mt-2 border border-white/60">
        <div className="z-10 max-w-xl">
          ...
          <button className="bg-[#F4A300] text-white px-8 py-4 rounded-full font-bold flex items-center gap-2 hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
            Input Transaksi
      ...
      {/* STAT CARDS - Dipaksa jadi rounded-3xl biar beneran melengkung */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 lg:col-span-2 hover:-translate-y-1 transition-transform duration-300">
          <h3 className="font-extrabold text-xl text-[#0B4D1E] mb-1">Aktivitas Bulanan</h3>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform duration-300">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 bg-[#F5EFE6] p-3 rounded-2xl">
              <div className="w-10 h-10 bg-gray-400 rounded-full flex items-center justify-center text-white font-bold">2</div>
            ...
            <div className="flex items-center gap-4 border-2 border-[#F4A300] p-3 rounded-2xl relative bg-orange-50">
              <div className="w-10 h-10 bg-[#CD7F32] rounded-full flex items-center justify-center text-white font-bold">3</div>
              <div>
          ...
          <button className="w-full mt-6 text-sm font-bold text-[#0B4D1E] hover:text-[#F4A300] flex items-center justify-center gap-2">Lihat Semua Peringkat <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg></button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 lg:col-span-2 hover:-translate-y-1 transition-transform duration-300">
          <div className="flex justify-between items-center mb-6">
            ...
            <button className="text-sm font-bold text-[#0B4D1E] hover:text-[#F4A300]">Lihat Selengkapnya →</button>
          </div>
          <div className="space-y-4">
            {[
        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform duration-300">
          ...
          <div className="relative border-l-2 border-gray-100 ml-6 space-y-10">
            <div className="relative pl-8">
              ...
              <p className="font-bold text-[#0B4D1E] text-sm">Transaksi plastik berhasil ditambahkan</p>
          ...
          <button className="w-full mt-8 text-sm font-bold text-[#0B4D1E] hover:text-[#F4A300] flex items-center justify-center gap-2">Lihat Semua Aktivitas →</button>
        </div>
      </div>
