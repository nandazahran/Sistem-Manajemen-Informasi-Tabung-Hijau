...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5EFE6] font-sans scroll-smooth overflow-x-hidden">
      ...
      <section id="home" className="relative min-h-screen flex flex-col items-center justify-start pt-28 md:pt-36 px-8 z-0">
        ...
        <div className="z-10 flex flex-col items-center text-center mt-2">
          ...
          <h1 data-aos="zoom-in" className="text-5xl md:text-7xl font-extrabold leading-tight tracking-tight drop-shadow-[0_4px_10px_rgba(255,255,255,0.8)]">
          ...
          <p data-aos="fade-up" data-aos-delay="200" className="mt-6 text-[#0B4D1E] max-w-2xl text-xl font-bold bg-[#F5EFE6]/80 backdrop-blur-md px-8 py-4 rounded-2xl shadow-sm border border-white/60">
            Sistem digital untuk pengelolaan sampah kampus yang terstruktur dan memberikan nilai ekonomi
          </p>

          <div data-aos="fade-up" data-aos-delay="400">
            <Link to="/login" className="inline-block mt-8 px-10 py-4 bg-[#F4A300] text-white font-extrabold rounded-full shadow-xl hover:bg-[#d68e00] transform hover:scale-105 transition-all">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <section id="about" className="min-h-screen bg-[#0B4D1E] text-white py-24 px-8 md:px-20 grid md:grid-cols-2 gap-12 items-center overflow-hidden">
        <div data-aos="fade-right">
          ...
          <p className="text-green-50 leading-relaxed mb-6 text-lg">
            SIM-TH adalah sistem informasi yang mendukung program <span className="text-[#F4A300] font-bold">Tabung Hijau</span> dalam pengelolaan sampah berbasis kampus secara digital, terstruktur, dan transparan.
          </p>
      ...
      <section id="how-it-works" className="min-h-screen bg-[#F4A300] py-24 px-8 md:px-20 flex flex-col justify-center overflow-hidden">
        <div data-aos="fade-up" className="mb-16 text-white text-center">
          <h2 className="text-5xl md:text-6xl font-extrabold mb-4 text-[#0B4D1E]">How does<br/>it work?</h2>
          <p className="text-lg opacity-90 font-medium text-[#0B4D1E]">Proses pengelolaan sampah kampus yang sistematis dan terstruktur</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          {[
            { step: '01', title: 'Pengumpulan', desc: 'Mahasiswa mengumpulkan sampah', icon: icon1 },
            { step: '02', title: 'Pemilahan', desc: 'Memilah berdasarkan jenis', icon: icon2 },
            { step: '03', title: 'Penyetoran', desc: 'Setor ke bank sampah', icon: icon3 },
            { step: '04', title: 'Pencatatan', desc: 'Input data digital', icon: icon4 },
            { step: '05', title: 'Distribusi', desc: 'Pembagian hasil', icon: icon5 },
          ].map((item, index) => (
            <div key={index} data-aos="fade-up" data-aos-delay={index * 100} className="bg-white rounded-3xl p-8 shadow-xl flex flex-col hover:-translate-y-3 transition-transform duration-300">
              <div className="flex justify-between items-start mb-6">
                <h3 className="text-5xl font-extrabold text-[#F5EFE6]">{item.step}</h3>
      ...
      {/* 4. BENEFITS SECTION */}
      <section id="benefits" className="min-h-screen bg-[#F5EFE6] py-24 px-8 md:px-20 flex flex-col justify-center items-center">
        <div className="max-w-6xl w-full">
          <h2 data-aos="fade-down" className="text-5xl md:text-6xl font-extrabold text-[#0B4D1E] mb-4">
            Benefits<span className="text-[#F4A300]">.</span>
          </h2>
          <p data-aos="fade-up" className="text-gray-500 text-lg mb-16 max-w-2xl font-medium">
            Keuntungan yang didapat dari program Tabung Hijau untuk kampus dan mahasiswa
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div data-aos="fade-up" data-aos-delay="100" className="bg-white rounded-[2rem] p-10 border-2 border-[#125B2A] shadow-xl hover:-translate-y-2 transition-transform duration-300">
              <div className="w-16 h-16 bg-[#125B2A] rounded-2xl flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
              </div>
              <h4 className="text-[#125B2A] font-extrabold text-[10px] tracking-widest uppercase mb-2">Environmental</h4>
              <h3 className="text-2xl font-extrabold text-[#0B4D1E] mb-4 leading-tight">Mengurangi sampah</h3>
              <p className="text-gray-500 font-medium text-sm leading-relaxed">
                Volume sampah kampus berkurang signifikan dengan sistem pemilahan yang terorganisir
              </p>
            </div>

            <div data-aos="fade-up" data-aos-delay="200" className="bg-white rounded-[2rem] p-10 border-2 border-[#F4A300] shadow-xl hover:-translate-y-2 transition-transform duration-300">
              ...
              <h4 className="text-[#F4A300] font-extrabold text-[10px] tracking-widest uppercase mb-2">Economic</h4>
              <h3 className="text-2xl font-extrabold text-[#0B4D1E] mb-4 leading-tight">Nilai ekonomi</h3>
              <p className="text-gray-500 font-medium text-sm leading-relaxed">
                Sampah anorganik memiliki nilai jual yang memberikan keuntungan finansial untuk mahasiswa
              </p>
            </div>

            <div data-aos="fade-up" data-aos-delay="300" className="bg-white rounded-[2rem] p-10 border-2 border-[#125B2A] shadow-xl hover:-translate-y-2 transition-transform duration-300">
              <div className="w-16 h-16 bg-[#125B2A] rounded-2xl flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M11.69 3.037a1 1 0 10-1.38-1.614l-7.5 6.429a1 1 0 00.315 1.713l3.655.845-1.954 6.643a1 1 0 101.92.564l7.5-6.429a1 1 0 00-.315-1.713l-3.655-.845 1.954-6.643z" clipRule="evenodd" /></svg>
              </div>
              <h4 className="text-[#125B2A] font-extrabold text-[10px] tracking-widest uppercase mb-2">Educational</h4>
              <h3 className="text-2xl font-extrabold text-[#0B4D1E] mb-4 leading-tight">Kesadaran lingkungan</h3>
              <p className="text-gray-500 font-medium text-sm leading-relaxed">
                Meningkatkan kepedulian dan edukasi mahasiswa terhadap pengelolaan sampah yang berkelanjutan
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="contact" className="relative min-h-screen flex flex-col justify-center pt-24 pb-48 px-8 md:px-20 bg-gradient-to-b from-[#F5EFE6] to-[#d7e3df] overflow-hidden">
        ...
        <div className="relative z-10">
          <div data-aos="fade-down" className="text-center mb-12">
            <h2 className="text-5xl md:text-6xl font-extrabold text-[#0B4D1E] mb-4">Contact <span className="text-[#F4A300]">Us.</span></h2>
            <p className="text-gray-600 text-lg font-medium">Hubungi kami untuk informasi lebih lanjut tentang SIM-TH</p>
          </div>
