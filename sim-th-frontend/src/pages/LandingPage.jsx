...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5EFE6] font-sans scroll-smooth overflow-x-hidden">
      ...
      {/* 1. HERO SECTION (Tinggi Full Layar) */}
      <section id="home" className="relative min-h-screen pt-20 px-6 flex flex-col items-center justify-center text-center">
        ...
        <p data-aos="fade-up" data-aos-delay="200" className="mt-6 text-gray-600 max-w-2xl text-lg font-medium">
          Sistem digital untuk pengelolaan sampah kampus yang terstruktur dan memberikan nilai ekonomi
        </p>
        <div data-aos="fade-up" data-aos-delay="400">
          <Link to="/login" className="inline-block mt-8 px-8 py-4 bg-[#F4A300] text-white font-extrabold rounded-full shadow-lg hover:bg-[#d68e00] transform hover:scale-105 transition-all">
            Get Started
          </Link>
        </div>
      </section>

      {/* 2. ABOUT SECTION (Tinggi Full Layar) */}
      <section id="about" className="min-h-screen bg-[#0B4D1E] text-white py-24 px-8 md:px-20 grid md:grid-cols-2 gap-12 items-center overflow-hidden">
        ...
        <div data-aos="fade-left" className="h-80 bg-white/10 rounded-3xl border-2 border-dashed border-white/20 flex justify-center items-center">
            <span className="text-white/50 font-medium">Gambar Ilustrasi About</span>
        </div>
      </section>

      {/* 3. HOW IT WORKS SECTION (Tinggi Full Layar) */}
      ...
      {/* 4. BENEFITS SECTION (BARU & Tinggi Full Layar) */}
      ...
      {/* 5. CONTACT US SECTION (Tinggi Full Layar) */}
      <section id="contact" className="relative min-h-screen flex flex-col justify-center pt-24 pb-48 px-8 md:px-20 bg-linear-to-b from-[#F5EFE6] to-[#d7e3df] overflow-hidden">
