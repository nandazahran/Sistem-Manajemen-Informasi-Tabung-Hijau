...
function LeaderboardPage() {
  ...
  return (
    <DashboardLayout>
      ...
      {loading ? (
        <div className="text-center py-20 text-gray-400 font-bold text-lg">Memuat data leaderboard...</div>
      ) : leaderboardData.length === 0 ? (
        <div className="text-center py-20 text-gray-400 font-bold text-lg">Belum ada data untuk periode ini.</div>
      ) : (
        <>
