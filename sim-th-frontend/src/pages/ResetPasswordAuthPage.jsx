...
function ResetPasswordAuthPage() {
  ...
  return (
    <AuthLayout title="Buat Password Baru" subtitle="Silakan masukkan password baru Anda untuk akun BEM Wilayah.">
      <form onSubmit={handleReset} className="flex flex-col gap-5 mt-4">
        ...
        <div>
          ...
          <div className="relative">
            <input 
              ...
              className="w-full bg-[#F5EFE6] px-5 py-4 rounded-2xl font-medium text-[#0B4D1E] outline-none pr-12 focus:ring-2 focus:ring-[#0B4D1E] transition-all"
            />
        ...
        <button type="submit" disabled={isLoading} className={`w-full text-white py-4 rounded-2xl font-bold transition-all shadow-md mt-4 ${isLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#0B4D1E] hover:bg-[#083a16] hover:-translate-y-1'}`}>
