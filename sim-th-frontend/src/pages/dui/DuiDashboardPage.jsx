...
function DuiDashboardPage() {
  ...
  const [stats, setStats] = useState([
    { title: 'Total Sampah Terkelola', value: '0 kg', badge: 'Memuat...', icon: 'M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2' },
    { title: 'Total Nilai Ekonomi', value: 'Rp 0', badge: 'Memuat...', icon: 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z' },
    ...
    const fetchDuiDashboard = async () => {
      try {
        ...
        if (dashData.status === 'sukses') {
          ...
          newStats[1].value = formatRp(dashData.rekap_seluruh_ipb?.total_rupiah || 0);
