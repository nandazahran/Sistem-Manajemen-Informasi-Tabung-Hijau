  ...
  return (
    <DuiLayout>
      ...
      <div className="bg-[#0B4D1E] rounded-[2rem] p-10 flex items-center gap-6 text-white mt-2 mb-8 shadow-sm">
        ...
        <div>
          <h2 className="text-3xl font-extrabold mb-2">DUI SIM-TH</h2>
          <div className="flex gap-2">
            <span className="bg-green-600/50 text-white text-xs px-3 py-1 rounded-full font-bold border border-green-500/50">dui@simth.ipb.ac.id</span>
            <span className="bg-white/10 text-white text-xs px-3 py-1 rounded-full font-bold border border-white/20">DUI</span>
      ...
      <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 mb-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            { label: 'Nama Lengkap', value: 'DUI SIM-TH', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
            { label: 'Email', value: 'dui@simth.ipb.ac.id', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
            { label: 'Role', value: 'DUI', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
          ...
          <div className="bg-white w-full max-w-lg rounded-[2.5rem] p-10 shadow-2xl relative animate-fade-in-up border border-gray-100">
            ...
            <form onSubmit={handleSaveProfile} className="space-y-5">
              <div>
                ...
                <input type="text" defaultValue="DUI SIM-TH" className="w-full bg-[#F5EFE6] px-5 py-4 rounded-2xl font-medium text-[#0B4D1E] outline-none focus:ring-2 focus:ring-[#125B2A]" />
              </div>
              <div>
                <label className="block text-sm font-bold text-[#0B4D1E] mb-2">Email</label>
                <input type="email" defaultValue="dui@simth.ipb.ac.id" className="w-full bg-[#F5EFE6] px-5 py-4 rounded-2xl font-medium text-[#0B4D1E] outline-none focus:ring-2 focus:ring-[#125B2A]" />
              </div>
              <div>
                <label className="block text-sm font-bold text-[#0B4D1E] mb-2">Nomor Telepon</label>
                <input type="text" defaultValue="081234567890" className="w-full bg-[#F5EFE6] px-5 py-4 rounded-2xl font-medium text-[#0B4D1E] outline-none focus:ring-2 focus:ring-[#125B2A]" />
              </div>
              <div>
                <label className="block text-sm font-bold text-[#0B4D1E] mb-2">Institusi</label>
                <input type="text" defaultValue="BEM KM IPB" className="w-full bg-[#F5EFE6] px-5 py-4 rounded-2xl font-medium text-[#0B4D1E] outline-none focus:ring-2 focus:ring-[#125B2A]" />
              </div>
